      ...
      <div className='mt-28 md:mt-36'>
        ...
        <div className='flex flex-col-reverse justify-center items-center md:flex-row md:px-32'>
          <div className='text-center md:text-left font-bellefair not-italic font-normal md:flex'>
                  <ul className="flex justify-center items-center md:flex-col py-5 md:py-0 md:space-y-8">
                      {records.map((menu, index) => (
                          <li key={index} className="font-bellefair font-normal text-white mr-4 md:mr-14 text-xl">
                  ...
                  <div>
                      <h3 className='text-lg md:text-lg font-barlowCondensed text-specialBlue uppercase mix-blend-normal opacity-50'>The Terminology...</h3>
